...
import { booleanAttribute, ChangeDetectionStrategy, Component, computed, input, model, numberAttribute, viewChild } from '@angular/core';
...
export class HlmCalendar<T> {
    ...
    protected readonly _btnClass = hlm(
        ...
        'data-[selected]:bg-(--azul) data-[selected]:text-primary-foreground data-[selected]:hover:bg-(--azul) dark:hover:text-accent-foreground data-[selected]:focus:bg-(--azul) data-[selected]:focus:text-primary-foreground',
