                ...
                items: [
                    {
                        ...
                        items: [
                            ...
                            {
                                id: 'group-administracion-item-servicio-cliente-subitem-evaluaciones',
                                tipo: 'subitem',
                                titulo: 'Evaluaciones',
                                icon: 'lucideStar',
                                url: '/administracion/servicio-cliente/evaluaciones',
                            },
                            {
                                id: 'group-administracion-item-servicio-cliente-subitem-mensajes',
                                tipo: 'subitem',
                                titulo: 'Mensajes',
                                icon: 'lucideMail',
                                url: '/administracion/servicio-cliente/mensajes',
                            },
                        ],
                    },
                    {
